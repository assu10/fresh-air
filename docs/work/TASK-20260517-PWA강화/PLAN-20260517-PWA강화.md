...
- [ ] **Step 3: useNotification 구조분해에 requiresInstall 추가**
...
- [ ] **Step 4: NotificationToggle에 requiresInstall prop 추가**
...
- [ ] **Step 5: 두 return문 모두 InstallPrompt 추가**
...
- [ ] **Step 1: WBS.md Phase 7 항목 완료 처리**
